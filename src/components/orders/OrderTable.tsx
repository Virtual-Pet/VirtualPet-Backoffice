              ...
              <td className="px-6 py-4">
                <div className="flex gap-2 flex-wrap">
                  <button
                    ...
                    className="px-3 py-1.5 rounded-lg text-xs cursor-pointer font-semibold transition-all border border-slate-200 bg-white hover:bg-slate-50 text-slate-600"
                    style={{ boxShadow: "var(--vp-shadow-sm)" }}
                  >
                    Ver detalle
                  </button>
                  {nextAction && activeTab === "CONFIRMED" && (
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-lg cursor-pointer text-white text-xs font-semibold transition-all ${nextAction.colorClass}`}
                      style={{ boxShadow: "var(--vp-shadow-sm)" }}
                    >
                      {nextAction.label}
                    </button>
                  ...
                  {canCancel && (
                    <button
                      ...
                      className="px-3 py-1.5 rounded-lg text-white cursor-pointer text-xs font-semibold transition-all bg-red-500 hover:bg-red-600"
                      style={{ boxShadow: "var(--vp-shadow-sm)" }}
                    >
                      Cancelar
                    </button>

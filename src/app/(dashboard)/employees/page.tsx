...
export default function EmployeesPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert(
        "Error al crear el empleado. Verificá los datos e intentá nuevamente.",
      );
    } finally {
    ...
    <div className="max-w-6xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">
          Administrá el acceso del personal operativo
        </p>
      </div>
      ...
      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
        ...
        <form
          ...
          className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-4 items-end"
        >
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    role: e.target.value as "ROLE_ADMIN" | "ROLE_EMPLOYEE",
                  })
                }
                className="w-full px-3 py-2 text-black border border-slate-200 rounded-lg text-sm outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20"
              >
